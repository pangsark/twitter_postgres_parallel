...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/pangsark/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/pangsark/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/pangsark/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/pangsark/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/pangsark/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/pangsark/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 10.76sec                  | 4.09sec                   | 
| `pg_normalized_batch`  | 6min 9.12sec              | 58.78sec                  | 
| `pg_denormalized`      | 1min 58.92sec             | 15.23sec                  | 
